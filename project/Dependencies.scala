...
object Dependencies {
  ...
  object Versions {
    ...
    val bouncyCastleV = "1.65"         //https://github.com/bcgit/bc-java/releases
    ...
    val http4sV       = "0.21.3"   //https://github.com/http4s/http4s/releases
    val scalacheckV   = "1.14.3"       //https://github.com/typelevel/scalacheck/releases
    val commonsCodecV = "1.14"         //https://github.com/apache/commons-codec/releases
    val fs2Version    = "2.3.0"        //https://github.com/functional-streams-for-scala/fs2/releases
